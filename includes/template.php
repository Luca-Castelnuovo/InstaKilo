...
function page_header($title = 'Unknown')
{
    ...
    <head>
        ...
        <link rel="stylesheet" href="https://cdn.lucacastelnuovo.nl/instakilo.lucacastelnuovo.nl/css/style.10.css" />
    </head>
...
function page_footer($extra = null)
{
    echo <<<HTML
        ...
        <script src="https://cdn.lucacastelnuovo.nl/instakilo.lucacastelnuovo.nl/js/app.110.js"></script>
HTML;
    alert_display();
    echo <<<HTML
    </body>
