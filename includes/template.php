...
function page_header($title = 'Unknown')
{
    ...
    <head>
        ...
        <link rel="stylesheet" href="https://cdn.lucacastelnuovo.nl/instakilo.lucacastelnuovo.nl/css/style.2.css" />
    </head>
...
function page_footer($extra)
{
    echo <<<HTML
        ...
        <script src="https://cdn.lucacastelnuovo.nl/instakilo.lucacastelnuovo.nl/js/app.47.js"></script>
HTML;
    alert_display();
    echo <<<HTML
    </body>
